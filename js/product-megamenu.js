const productsMegaMenu = {
    ...
    /* ================= ARC SERIES ================= */
    "ARC SERIES": {
        desc: "Single, 1+2, 1+2+3 & Three Phase",
        products: [
            {
                id: "ARC_200_IGOLD",
                name: "ARC 200-IGOLD",
    ...
    /* ================= TIG SERIES ================= */
    "TIG SERIES": {
        desc: "Single & Three Phase TIG Welders",
        products: [
            {
                id: "TIG_250_IJ_S",
                name: "TIG 250 IJ-S",
    ...
    /* ================= CUT SERIES ================= */
    "CUT SERIES": {
        desc: "Three Phase Plasma Cutting",
        products: [
            {
                id: "CUT_100_LGK",
                name: "CUT-100 LGK",
    ...
    /* ================= PORTABLE ARC SERIES ================= */
    "PORTABLE ARC SERIES": {
        desc: "Portable Welding Machines",
        products: [
            {
                id: "APT_200",
                name: "APT-200",
    ...
    /* ================= WELDING ACCESSORIES ================= */
    "WELDING ACCESSORIES": {
        desc: "Welding Tools & Accessories",
        products: [
            {
                id: "WELDING_HELMET",
                name: "Auto Darkening Helmet",
                img: "./images/product-main.png",
                desc: "Eye protection helmet"
            },
            {
                id: "WELDING_CABLE",
                name: "Welding Cable",
                img: "./images/product-main.png",
                desc: "High conductivity cable"
            },
            {
                id: "ELECTRODE_HOLDER",
                name: "Electrode Holder",
                img: "./images/product-main.png",
                desc: "Durable electrode holder"
            },
            {
                id: "EARTH_CLAMP",
                name: "Earth Clamp",
...
const rightContent = document.getElementById("dropdownRight");
    ...
    data.products.forEach(product => {
        wrapper.innerHTML += `
            <div class="swiper-slide">
                <a href="./product-details.html?id=${product.id}" class="content-card">
